...
$result= $obj->select('post','*'," category on post.category=category.category_id JOIN user on post.author=user.user_id"," user_id= $user_id ","post_id DESC",3);
?>
    <div id="main-content">
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                  <h2 class="page-heading">Author: <?php echo $username; ?></h2>
<?php 
...
echo $obj->pagination('post',null," author= $user_id",3,"user_id=$user_id&username=$username&"); 
?>
                </div><!-- /post-container -->
            </div>
